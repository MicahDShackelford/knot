...
.. moduleauthor:: micah_shackelford <micahdshackelford@gmail.com>
"""
...
setup(
    name='knot',
    description="Simplified package linking",
    ...
    license='MIT',  # noqa
    author='micah_shackelford',
    author_email='micahdshackelford@gmail.com',
    # Use the URL to the github repo.
    url= 'https://github.com/MicahDShackelford/knot',
    download_url=(
        f'https://github.com/MicahDShackelford/'
        f'knot/archive/{version}.tar.gz'
    ),
    keywords=[
